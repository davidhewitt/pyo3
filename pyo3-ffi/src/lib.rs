...
// Root "include/Python.h" entry point for Python C-API bindings.
#[path = "include/Python.rs"]
mod include;
pub use include::*;

// This header is not exported by `Python.h` and needs to be included separately.
